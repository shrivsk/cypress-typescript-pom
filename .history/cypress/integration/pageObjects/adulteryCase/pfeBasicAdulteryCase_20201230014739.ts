...
// ***********************************************
import pfeLoginPage from '../loginPage/pfeLoginPage.js'
// ***********************************************
class pfeAdulteryPage extends pfeLoginPage {
  const pfeLoginPage1 = new pfeLoginPage()
/*   constructor() {
    this.pfeLoginPages = new pfeLoginPage();
  } */

  basicAdulteryCase() {
    const lP = this.pfeLoginPage1
    lP.createIdamUser()
    lP.openPfeUrl()
    lP.enterUserID()
    lP.enterPassword()
    ...
    cy.get('.govuk-body-reference-number')
      ...
      const caseidtxt=$caseid.text()
      expect(caseidtxt).eq(caseidtxt)
      cy.log('Case ID -->'+ caseidtxt)
  })
}}
export default pfeAdulteryPage