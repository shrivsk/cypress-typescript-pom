...
exports.pfeAdulteryCostPayCard = void 0;
/// <reference types="cypress" />
// ***********************************************
var loginPage_1 = require("../pfepages/loginPage");
var ccdCaseId;
// ***********************************************
var pfeAdulteryCostPayCard = /** @class */ (function () {
    function pfeAdulteryCostPayCard() {
        this.pfeLoginPg = new loginPage_1.pfeLoginPage();
    }
    pfeAdulteryCostPayCard.prototype.adulteryCaseCostPaybyCard = function () {
        var lP = this.pfeLoginPg;
        lP.createIdamUser();
        lP.openPfeAatUrl();
        lP.enterUserID();
        lP.enterPassword();
        ...
        var sum = cy.get('@pfeCaseId');
        return sum;
    };
    return pfeAdulteryCostPayCard;
}());
exports.pfeAdulteryCostPayCard = pfeAdulteryCostPayCard;
exports.default = pfeAdulteryCostPayCard;
